              ...
              {customUser && (
                <div className="relative">
                  ...
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="text-yellow-800 w-6 h-6 absolute top-1/2 -translate-y-1/2 right-[-32px] cursor-pointer"
                    onClick={() => {
                      setCustomUser(null);
            ...
            <div className="flex flex-col items-center ">
              ...
              <div className="flex flex-col items-center justify-center w-full mt-3">
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:border-yellow-200 hover:bg-gray-100"
                >
